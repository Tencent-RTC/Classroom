export default {
  'The room does not exist, please confirm the room number or create a room!':
    'The classroom does not exist, please confirm the room number or create a classroom!',
  'Log out': 'Log out',
  ...
  'kicked out of the room by the host': 'kicked out of the room by the teacher or assistant',
  ...
  'sb invites you to join the conference': ({ named }: any) =>
    `${named('name')} invites you to join the classroom`,
  // media privilege
