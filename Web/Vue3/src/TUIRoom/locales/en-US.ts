export default {
  'The room does not exist, please confirm the room number or create a room!':
    'The classroom does not exist, please confirm the classroom number or create a classroom!',
  'Log out': 'Log out',
  ...
  'Join the room ?': 'Join the classroom ?',
  'You are invited to room ': 'You are invited to classroom ',
  Room: 'Class',
  Join: 'Join',
  Sure: 'Sure',
  'Switch Theme': 'Switch Theme',
  Layout: 'Layout',
  'New Room': 'New Classroom',
  ...
  'Free Speech Room': 'Small Class',
  'On-stage Speaking Room': 'Small Class',
  'Join Room': 'Join Classroom',
  'Enter room ID': 'Enter room ID',
  'video conferencing': " 's video conferencing",
  'Quick Conference': " 's Classroom",
  'Room ID': 'Class ID',
  ...
  'Enable AI real-time meeting recording':
    'Enable AI real-time classroom recording',
  ...
  'Make host': 'Make host',
  'Set as administrator': 'Set as assistant',
  'Remove administrator': 'Remove assistant',
  'The administrator status of sb has been withdrawn': ({ named }: any) =>
    `The assistant status of ${named('name')} has been withdrawn`,
  'sb has been set as assistant': ({ named }: any) =>
    `${named('name')} has been set as assistant`,
  'You have been invited by the administrator to step down, please raise your hand if you need to speak':
    'You have been invited by the assistant to step down, please raise your hand if you need to speak',
  Invite: 'Invite',
  Settings: 'Settings',
  ...
  'You are currently the host of the room, please choose the corresponding operation. If you choose "End Room", the current room will be disbanded and all members will be removed. If you choose "Leave Room", the current room will not be disbanded, and your hosting privileges will be transferred to other members.':
    'You are currently the teacher of the room, please choose the corresponding operation. If you choose "End Class", the current class will be disbanded and all members will be removed. If you choose "Leave ClassRoom", the current classroom will not be disbanded, and you can enter classroom again.',
  'You are currently the host of the room, please choose the corresponding operation. If you choose "End Room", the current room will be disbanded and all members will be removed.':
    'You are currently the teacher of the room, please choose the corresponding operation. If you choose "End Class", the current class will be disbanded and all members will be removed.',
  ...
  'The host closed the room.': 'The teacher closed the classroom.',
  Note: 'Note',
  Confirm: 'Confirm',
  Leave: 'Leave',
  Dismiss: 'Dismiss',
  'The administrator has been changed to ':
    'The assistant has been changed to ',
  'Muted by the moderator': 'Muted by the teacher or assistant',
  ...
  'You have been invited by the host to step down, please raise your hand if you need to speak':
    'You have been invited by the teacher or assistant to step down, please raise your hand if you need to speak',
  ...
  'Share the room ID or invite link': 'Share the classroom ID or invite link',
  'Invite by room number': 'Invite by classroom number',
  'Invite via room link': 'Invite via classroom link',
  'Room Link': 'Class Link',
  'You can share the room number or link to invite more people to join the room.':
    'You can share the classroom number or link to invite more people to join the classroom.',
  'You can share the room number to invite more people to join the room':
    'You can share the classroom number to invite more people to join the classroom',
  'If you have any questions, please feel free to join our QQ group or send an email':
    'If you have any questions, please feel free to join our QQ group or send an email',
  'Room QR code': 'Class QR code',
  ...
  'The host has turned off your screen sharing':
    'The teacher or assistant has turned off your screen sharing',
  ...
  'kicked out of the room by the host': 'kicked out of the classroom by the teacher or assistant',
  'kicked out of the room by other device':
    'kicked out of the classroom by other device',
  'kicked out of the room by serve': 'kicked out of the classroom by serve',
  ...
  'Has been muted by the host and cannot open the microphone':
    'Has been muted by the teacher or assistant and cannot open the microphone',
  'To apply to speak in the room, please raise your hand first to apply for the microphone':
    'To apply to speak in the classroom, please raise your hand first to apply for the microphone',
  'Has been full static painting, can not open the video':
    'Has been full static painting, can not open the video',
  'It has been stilled by the host and cannot open the video':
    'It has been stilled by the teacher or assistant and cannot open the video',
  'Failed to enter the room.': 'Failed to enter the classroom.',
  ...
  'Sharing screens may lead to the leakage of private information such as SMS verification codes and passwords, resulting in financial losses. Please be vigilant against various forms of fraud.':
    'Sharing screens may lead to the leakage of private information such as SMS verification codes and passwords, resulting in financial losses. Please be vigilant against various forms of fraud.',
  'Please enter the room number': 'Please enter the classroom number',
  'whether to kick sb off the room': ({ named }: any) =>
    `whether to kick ${named('name')} off the classroom`,
  ...
  'Sb has been set as an administrator': ({ named }: any) =>
    `${named('name')} has been set as an assistant.`,
  ...
  'Members will not be able to open the camera':
    'Members will not be able to open the camera',
  'You have become a administrator': 'You have become a assistant',
  'You are now a room owner': 'You are now the teacher',
  'Your administrator status has been revoked':
    'Your assistant status has been revoked',
  ...
  'Application to go on stage was rejected':
    'Application to go on stage was rejected',
  'You are now an administrator': 'You are now an assistant',
  'The RoomOwner has withdrawn your administrator privileges':
    'The teacher has withdrawn your assistant privileges',
  ...
  'To go on stage again, you need to reapply and wait for the roomOwner/administrator to approve':
    'To go on stage again, you need to reapply and wait for the teacher/assistant to approve',
  ...
  'The request to go on stage has been sent out, please wait for the roomOwner/administrator to approve it':
    'The request to go on stage has been sent out, please wait for the teacher/assistant to approve it',
  'Cancellation request has been sent, please wait for the roomOwner/administrator to approve it':
    'Cancellation request has been sent, please wait for the teacher/assistant to approve it',
  ...
  'quick conference': 'classroom',
  Meeting: 'Classroom',
  'Meeting in progress': 'Classroom in progress',
  Initiating: 'Initiating',
  'X people have joined': ({ named }: any) =>
    `${named('number')} people have joined`,
  'Waiting for members to join the meeting':
    'Waiting for members to join the classroom',
  'X people are in the meeting': ({ named }: any) =>
    `${named('number')} people are in the classroom`,
  'Already joined': 'Already joined',
  'Enter the meeting': 'Enter the classroom',
  'Ending meeting': 'Ending classroom',
  'The meeting has ended': 'The classroom has ended',
  'Currently in a meeting, please exit the current meeting before proceeding.':
    'Currently in a classroom, please exit the current classroom before proceeding.',
  'Failed to initiate meeting': 'Failed to initiate classroom',
  'Failed to enter the meeting': 'Failed to enter the classroom',
  'Failed to disable chat': 'Failed to disable chat',
  'All members can share screen': 'All members can share screen',
  'Screen sharing for host/admin only': 'Screen sharing for teacher/assistant only',
  'Failed to initiate screen sharing, currently only host/admin can share screen.':
    'Failed to initiate screen sharing, currently only teacher/assistant can share screen.',
  'Is it turned on that only the host/admin can share the screen?':
    'Is it turned on that only the teacher/assistant can share the screen?',
  ...
  'Your screen sharing has been stopped, Now only the host/admin can share the screen':
    'Your screen sharing has been stopped, Now only the teacher/assistant can share the screen',
  ...
  'modify room': 'modify classroom',
  'cancel room': 'cancel classroom',
  Modify: 'Modify',
  'No room available for booking': 'No classroom available for booking',
  Ongoing: 'Ongoing',
  finished: 'finished',
  'History room': 'History classroom',
  'sb temporary room': ({ named }: any) => `${named('name')}'s classroom`,
  year: 'year',
  month: 'month',
  day: 'day',
  Schedule: 'Schedule',
  ...
  people: 'people',
  'Scheduled meetings': 'scheduled classrooms',
  minute: 'minute',
  hour: 'hour',
  minutes: 'minutes',
  hours: 'hours',
  'The start time cannot be earlier than the current time':
    'The start time cannot be earlier than the current time',
  'Room Time': 'Class Time',
  Creator: 'Creator',
  'Room Details': 'Class Details',
  'Enter Now': 'Enter Now',
  'Invited members': 'Invited members',
  'The room is closed': 'The classroom is closed',
  ...
  'Invitation by room ID': 'Invitation by classroom ID',
  'Invitation via room link': 'Invitation via classroom link',
  'Copy the conference number and link': 'Copy the classroom number and link',
  ...
  'The room name cannot exceed 100 characters':
    'The classroom name cannot exceed 100 characters',
  'The room name cannot be empty': 'The classroom name cannot be empty',
  'The meeting is in progress and any meeting information cannot be modified':
    'The classroom is in progress and any classroom information cannot be modified',
  'Schedule room loading': 'Schedule classroom loading...',
  'The user name cannot exceed 32 characters':
    'The user name cannot exceed 32 characters',
  'sb invites you to join the conference': ({ named }: any) =>
    `${named('name')} invites you to join the class`,
  // media privilege
  ...
  'Busy line': 'Busy line',
  // room password
  'Entering the room now...': 'Entering the classroom now...',
  'The room is encrypted': 'The classroom is encrypted',
  'Please enter the password': 'Please enter the password',
  'Your room password format is incorrect, please check it':
    'Your classroom password format is incorrect, please check it',
  Security: 'Security',
  'Room Password': 'Class Password',
