export default {
  ...
  More: '更多',
  'AI Assistant': 'AI 助手',
  'AI real-time conference content': 'AI 实时课堂内容',
  'Turn on AI real-time subtitles': '开启AI实时字幕',
  'Turn off AI real-time subtitles': '关闭AI实时字幕',
  'Enable AI real-time meeting recording': '开启AI实时课堂记录',
  'Raise hand': '举手',
  Agree: '同意',
  Chat: '聊天',
  Cancel: '取消',
  ...
  'Search Member': '搜索成员',
  'Make host': '转交房主',
  'Set as administrator': '设为助教',
  'Remove administrator': '撤销助教',
  'The administrator status of sb has been withdrawn': ({ named }: any) =>
    `已将 ${named('name')} 的助教身份撤回`,
  ...
  'You are currently the host of the room, please choose the corresponding operation. If you choose "End Room", the current room will be disbanded and all members will be removed. If you choose "Leave Room", the current room will not be disbanded, and your hosting privileges will be transferred to other members.':
    '您当前是老师，请选择相应操作。若选择“下课”，将解散当前课堂并将全体成员移出。若选择“离开课堂”，当前课堂不会解散，您可以再进入课堂。',
  'You are currently the host of the room, please choose the corresponding operation. If you choose "End Room", the current room will be disbanded and all members will be removed.':
    '您当前是老师，请选择相应操作。若选择“下课”，将解散当前课堂并将全体成员移出。',
  'If you do not want to end the meeting, please designate a new host before leaving the meeting.':
    '如果您不想结束会议，请在离开会议前指定新的主持人。',
  'Are you sure you want to leave this room?': '确定离开课堂吗？',
  'New host': '选择主持人',
  'Transfer and leave': '移交并离开',
  'Leave room?': '是否要离开课堂',
  'Select a new host': '请选择新的房间主持人',
  'Appoint a new host': '指定一位新的主持人',
  'The host closed the room.': '老师宣布下课，已解散课堂',
  Note: '通知',
  Confirm: '确认',
  Leave: '离开课堂',
  Dismiss: '下课',
  'The administrator has been changed to ': '助教已变更为',
  'Muted by the moderator': '已被老师或助教禁言',
  'Type a message': '说点什么...',
  Send: '发送',
  ...
  'Share the room ID or invite link':
    '您可以通过复制课堂号或者邀请链接的方式邀请更多人加入课堂',
  'Invite by room number': '通过课堂号邀请',
  'Invite via room link': '通过课堂链接邀请',
  'Room Link': '课堂链接',
  'You can share the room number or link to invite more people to join the room.':
    '您可以分享课堂号或链接邀请更多人加入课堂。',
  ...
  'Sb invites you to turn on the camera': ({ named }: any) =>
    `${named('role')}邀请你打开摄像头`,
  'The host has turned off your screen sharing': '老师或助教已关闭您的屏幕分享',
  'Turn on the camera': '打开摄像头',
  'Keep it closed': '保持关闭',
  'You have been banned from text chat': '您被禁止文字聊天',
  'You are allowed to text chat': '您被允许文字聊天',
  'kicked out of the room by the host': '被老师或助教踢出课堂',
  'kicked out of the room by other device': '相同账号在其他客户端进入课堂',
  'kicked out of the room by serve': '被服务端踢出课堂',
  ...
  'It has been stilled by the host and cannot open the video':
    '已被老师或助教静画，无法打开视频',
  'Failed to enter the room.': '进入课堂失败！',
  ...
  'Please enter the room number': '请输入课堂号',
  ...
  'You have become a administrator': '您已成为助教',
  'You are now a room owner': '您已成为老师',
  'Your administrator status has been revoked': '您的助教身份被收回',
  ...
  'You are now an administrator': '您已成为助教',
  ...
  'quick conference': '课堂',
  Meeting: '课堂',
  'Meeting in progress': '课堂 进行中',
  Initiating: '正在发起',
  'X people have joined': ({ named }: any) => `${named('number')} 人已加入课堂`,
  'Waiting for members to join the meeting': '等待成员加入课堂',
  'X people are in the meeting': ({ named }: any) =>
    `${named('number')} 人在课堂中`,
  'Already joined': '已经加入课堂',
  'Enter the meeting': '进入课堂',
  'Ending meeting': '正在结束课堂',
  'The meeting has ended': '课堂已结束',
  'Currently in a meeting, please exit the current meeting before proceeding.':
    '正在课堂中，请先退出当前课堂后再进行操作',
  'Failed to initiate meeting': '创建课堂失败',
  'Failed to enter the meeting': '进入课堂失败',
  'Failed to disable chat': '禁言失败',
  'All members can share screen': '全体成员可共享屏幕',
  'Screen sharing for host/admin only': '仅老师/助教可共享屏幕',
  ...
  'modify room': '修改课堂',
  'cancel room': '取消课堂',
  'No room available for booking': '暂无预订课堂',
  Ongoing: '进行中',
  finished: '已结束',
  'History room': '历史课堂',
  'sb temporary room': ({ named }: any) => `${named('name')}的课堂`,
  year: '年',
  month: '月',
  day: '日',
  Schedule: '预订课堂',
  ...
  'Busy line': '忙线中',
  // room password
  'Entering the room now...': '正在进入课堂...',
  'The room is encrypted': '课堂已加密',
  'Please enter the password': '请输入课堂密码',
  'Your room password format is incorrect, please check it':
    '课堂密码格式不正确，请检查',
  Security: '安全设置',
  'Room Password': '课堂密码',
  'Enter 6-digit password': '请输入6位课堂密码',
  'Wrong password': '密码错误',
  Encryption: '课堂加密',
